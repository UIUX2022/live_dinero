  ...
  return (
    <div className="sidebar">
      <div className="userProfile">
        <img src="/images/userProfile.png" alt="pic" />
        <div>
      ...
      <ul className="my-3 sideBar-menu">
        ...
        <li className={`sideBarLink ${
            local.pathname == "/user_services" ||  local.pathname == "/create_services" ? " active" : " "
          }`}>
          <Link to="/user_services">
            <Icon icon="entypo:tools" />
            <span>Services</span>
          </Link>
        </li>
        <li className={`sideBarLink ${
            local.pathname == "/user_adds" || local.pathname == "/create_adds" ? " active" : " "
          }`}>
          <Link to="/user_adds">
